...
wire [31:0] fs_nextpc;
wire        int_stall_req;
wire [`TRAP_INFO_WD-1:0] trap_info_bus;
...
interrupt u_interrupt(
    .nextpc         (fs_nextpc      ),
    .int_stall_req  (int_stall_req  ),
    .trap_info_bus  (trap_info_bus  )
);
...
wire [31:0] csr_era;
wire [31:0] csr_badv;
wire [31:0] exc_entry_addr;

// CSR register module
csr_register u_csr_register(
    .clk            (clk            ),
    .reset          (reset          ),
    .csr_we         (csr_we         ),
    .csr_waddr      (csr_waddr      ),
...
trap_unit u_trap_unit(
    ...
    .csr_waddr      (csr_waddr      ),
    .csr_wdata      (csr_wdata      ),
    .csr_crmd_rdata (csr_crmd       ),
    .exc_entry_addr (exc_entry_addr )
);
// ID stage
id_stage id_stage(
    .clk            (clk            ),
