module Wb_reg (
    ...
    input wire [5:0] mem_int_ecode,
    input wire [7:0] mem_int_esubcode,
    ...
    output reg [5:0] wb_int_ecode,
    output reg [7:0] wb_int_esubcode,
...
always @(posedge clk ) begin
    ...
    if (rst||wb_ex===1'b1) begin
        ...
        wb_int_ecode<=mem_int_ecode;
        wb_int_esubcode<=mem_int_esubcode;
        wb_rj<=mem_rj;
